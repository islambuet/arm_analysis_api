...
class SixCropSalesPlanningController extends RootController
{
        ...
        if ($this->permissions->action_0 == 1) {
            ...
            if($itemId>0){
                ...
                if (!$result) {
                    ...
                    if ($result->compare_variety) {
                        $result->compare_variety = json_decode($result->compare_variety);
                    }
    ...
    public function saveItem(Request $request): JsonResponse
    {
        ...
        $validation_rule['compare_variety'] = ['nullable'];
        ...
        if(isset($itemNew['compare_variety'])){
            $itemNew['compare_variety']=json_encode($itemNew['compare_variety']);
        }
